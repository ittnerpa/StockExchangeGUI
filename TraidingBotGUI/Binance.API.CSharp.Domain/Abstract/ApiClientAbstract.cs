...
namespace Binance.API.Csharp.Client.Domain.Abstract
{
    public abstract class ApiClientAbstract
    {
        ...
        /// <param name="addDefaultHeaders">1 = Binance, 2 = CryptoPanic</param>
        public ApiClientAbstract(string apiKey, string apiSecret, string apiUrl = @"https://www.binance.com", string webSocketEndpoint = @"wss://stream.binance.com:9443/ws/", int addDefaultHeaders = 1)
        {
            _apiUrl = apiUrl;
            _apiKey = apiKey;
            ...
            if (addDefaultHeaders >= 0)
            {
                ConfigureHttpClient(addDefaultHeaders);
            }
        }
        ...
        /// </summary>
        private void ConfigureHttpClient(int HeaderChoice)
        {
            switch (HeaderChoice)
            {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    //CoinMarketCal Header
                    _httpClient.DefaultRequestHeaders
                        .Add("Authorization", _apiKey);
                    break;
                default:
                    throw (new ArgumentException("Use valid number as default header"));
            }           
