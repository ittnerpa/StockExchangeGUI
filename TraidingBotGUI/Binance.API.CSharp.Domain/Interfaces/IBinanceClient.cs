...
namespace Binance.API.Csharp.Client.Domain.Interfaces
{
    public interface IBinanceClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        dynamic TestConnectivity();

        /// <summary>
        /// Test connectivity to the Rest API and get the current server time.
        /// </summary>
        /// <returns></returns>
        ServerInfo GetServerTime();
        #endregion
        ...
        /// <param name="limit">Limit of records to retrieve.</param>
        /// <returns></returns>
        IEnumerable<AggregateTrade> GetAggregateTrades(string symbol, int limit = 500);
        ...
        /// <param name="limit">Limit of records to retrieve.</param>
        /// <returns></returns>
        IEnumerable<Candlestick> GetCandleSticks(string symbol, TimeInterval interval, DateTime? startTime = null, DateTime? endTime = null, int limit = 500);
        ...
        /// <param name="symbol">Ticker symbol.</param>
        /// <returns></returns>
        IEnumerable<PriceChangeInfo> GetPriceChange24H(string symbol);

        /// <summary>
        /// Latest price for all symbols.
        /// </summary>
        /// <returns></returns>
        IEnumerable<SymbolPrice> GetAllPrices();

        /// <summary>
        /// Best price/qty on the order book for all symbols.
        /// </summary>
        /// <returns></returns>
        IEnumerable<OrderBookTicker> GetOrderBookTicker();
        #endregion
        ...
        /// <returns></returns>
        NewOrder PostNewOrder(string symbol, decimal quantity, decimal price, OrderSide side, OrderType orderType = OrderType.LIMIT, TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        dynamic PostNewOrderTest(string symbol, decimal quantity, decimal price, OrderSide side, OrderType orderType = OrderType.LIMIT, TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        Order GetOrder(string symbol, long? orderId = null, string origClientOrderId = null, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        CanceledOrder CancelOrder(string symbol, long? orderId = null, string origClientOrderId = null, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        IEnumerable<Order> GetCurrentOpenOrders(string symbol, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        IEnumerable<Order> GetAllOrders(string symbol, long? orderId = null, int limit = 500, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        AccountInfo GetAccountInfo(long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        IEnumerable<Trade> GetTradeList(string symbol, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        WithdrawResponse Withdraw(string asset, decimal amount, string address, string addressName = "", long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        DepositHistory GetDepositHistory(string asset, DepositStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 6000000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        WithdrawHistory GetWithdrawHistory(string asset, WithdrawStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 6000000);
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        UserStreamInfo StartUserStream();
        ...
        /// <returns></returns>
        dynamic KeepAliveUserStream(string listenKey);
        ...
        /// <returns></returns>
        dynamic CloseUserStream(string listenKey);
        #endregion
