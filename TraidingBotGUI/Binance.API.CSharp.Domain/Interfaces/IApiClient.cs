...
namespace Binance.API.Csharp.Client.Domain.Interfaces
{
    public interface IApiClient
    {
        ...
        /// <summary>
        /// Receive JSON Files from a specific endpoint and parameteres 
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="endpoint">URL Endpoint</param>
        /// <param name="parameters">Filter results</param>
        /// <returns></returns>
        Task<T> CallAsyncWebClient<T>(string endpoint, string parameters = null);
