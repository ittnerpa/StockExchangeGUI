...
namespace Binance.API.Csharp.Client
{
    public class BinanceClient : BinanceClientAbstract, IBinanceClient
    {
        ...
        {
            var apiClient = new ApiClient("", "", EndPoints.TradingRules, addDefaultHeaders: 1);
        ...
        /// </summary>
        /// <returns></returns>
        public dynamic TestConnectivity()
        {
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.GET, EndPoints.TestConnectivity, false);
        ...
        public OrderBook GetOrderBook(string symbol, int limit = 100)
        {
            ...
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.GET, EndPoints.OrderBook, false, $"symbol={symbol.ToUpper()}&limit={limit}");
        ...
        public IEnumerable<AggregateTrade> GetAggregateTrades(string symbol, int limit = 500)
        {
            ...
            var result = _apiClient.CallAsync<IEnumerable<AggregateTrade>>(ApiMethod.GET, EndPoints.AggregateTrades, false, $"symbol={symbol.ToUpper()}&limit={limit}");
        ...
        /// <param name="limit">Limit of records to retrieve.</param>
        /// <returns></returns>
        public IEnumerable<Candlestick> GetCandleSticks(string symbol, TimeInterval interval, DateTime? startTime = null, DateTime? endTime = null, int limit = 500)
        {
            if (string.IsNullOrWhiteSpace(symbol))
            {
                throw new ArgumentException("symbol cannot be empty. ", "symbol");
            ...
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.GET, EndPoints.Candlesticks, false, args);
        ...
        /// <param name="symbol">Ticker symbol.</param>
        /// <returns></returns>
        public IEnumerable<PriceChangeInfo> GetPriceChange24H(string symbol = "")
        {
            ...
            {
                var data = _apiClient.CallAsync<PriceChangeInfo>(ApiMethod.GET, EndPoints.TickerPriceChange24H, false, args);
                result.Add(data.Result);
            }
            else
            {
                result = _apiClient.CallAsync<List<PriceChangeInfo>>(ApiMethod.GET, EndPoints.TickerPriceChange24H, false, args).Result;
            }
        ...
        {
            var result = _apiClient.CallAsync<IEnumerable<SymbolPrice>>(ApiMethod.GET, EndPoints.AllPrices, false);
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<OrderBookTicker> GetOrderBookTicker()
        {
            var result = _apiClient.CallAsync<IEnumerable<OrderBookTicker>>(ApiMethod.GET, EndPoints.OrderBookTicker, false);
        ...
        /// <returns></returns>
        public NewOrder PostNewOrder(string symbol, decimal quantity, decimal price, OrderSide side, OrderType orderType = OrderType.LIMIT, TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m, long recvWindow = 5000)
        {
            ...
            var result = _apiClient.CallAsync<NewOrder>(ApiMethod.POST, EndPoints.NewOrder, true, args);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        public dynamic PostNewOrderTest(string symbol, decimal quantity, decimal price, OrderSide side, OrderType orderType = OrderType.LIMIT, TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m, long recvWindow = 5000)
        {
            //Validates that the order is valid.
            ValidateOrderValue(symbol, orderType, price, quantity, icebergQty);
            ...
            var args = $"symbol={symbol.ToUpper()}&side={side}&type={orderType}&quantity={quantity}"
                ...
                + (icebergQty > 0m ? $"&icebergQty={icebergQty}" : "")
                + $"&recvWindow={recvWindow}";
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.POST, EndPoints.NewOrderTest, true, args);
        ...
        public Order GetOrder(string symbol, long? orderId = null, string origClientOrderId = null, long recvWindow = 5000)
        {
            ...
            var result = _apiClient.CallAsync<Order>(ApiMethod.GET, EndPoints.QueryOrder, true, args);
        ...
        public CanceledOrder CancelOrder(string symbol, long? orderId = null, string origClientOrderId = null, long recvWindow = 5000)
        {
            ...
            var result = _apiClient.CallAsync<CanceledOrder>(ApiMethod.DELETE, EndPoints.CancelOrder, true, args);
        ...
        public IEnumerable<Order> GetCurrentOpenOrders(string symbol, long recvWindow = 5000)
        {
            ...
            var result =  _apiClient.CallAsync<IEnumerable<Order>>(ApiMethod.GET, EndPoints.CurrentOpenOrders, true, $"symbol={symbol.ToUpper()}&recvWindow={recvWindow}");
        ...
        public IEnumerable<Order> GetAllOrders(string symbol, long? orderId = null, int limit = 500, long recvWindow = 5000)
        {
            ...
            var result = _apiClient.CallAsync<IEnumerable<Order>>(ApiMethod.GET, EndPoints.AllOrders, true, $"symbol={symbol.ToUpper()}&limit={limit}&recvWindow={recvWindow}" + (orderId.HasValue ? $"&orderId={orderId.Value}" : ""));
        ...
        {
            var result = _apiClient.CallAsync<AccountInfo>(ApiMethod.GET, EndPoints.AccountInformation, true, $"recvWindow={recvWindow}");
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        public IEnumerable<Trade> GetTradeList(string symbol, long recvWindow = 5000)
        {
            if (string.IsNullOrWhiteSpace(symbol))
            {
                throw new ArgumentException("symbol cannot be empty. ", "symbol");
            ...
            var result = _apiClient.CallAsync<IEnumerable<Trade>>(ApiMethod.GET, EndPoints.TradeList, true, $"symbol={symbol.ToUpper()}&recvWindow={recvWindow}");
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        public WithdrawResponse Withdraw(string asset, decimal amount, string address, string addressName = "", long recvWindow = 5000)
        {
            ...
            var result = _apiClient.CallAsync<WithdrawResponse>(ApiMethod.POST, EndPoints.Withdraw, true, args);
        ...
        public DepositHistory GetDepositHistory(string asset, DepositStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 5000)
        {
            ...
            var result =  _apiClient.CallAsync<DepositHistory>(ApiMethod.POST, EndPoints.DepositHistory, true, args);
        ...
        public WithdrawHistory GetWithdrawHistory(string asset, WithdrawStatus? status = null, DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 5000)
        {
            ...
            var result = _apiClient.CallAsync<WithdrawHistory>(ApiMethod.POST, EndPoints.WithdrawHistory, true, args);
        ...
        /// </summary>
        /// <returns></returns>
        public UserStreamInfo StartUserStream()
        {
            var result = _apiClient.CallAsync<UserStreamInfo>(ApiMethod.POST, EndPoints.StartUserStream, false);
        ...
        /// <returns></returns>
        public dynamic KeepAliveUserStream(string listenKey)
        {
            ...
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.PUT, EndPoints.KeepAliveUserStream, false, $"listenKey={listenKey}");
        ...
        /// <returns></returns>
        public dynamic CloseUserStream(string listenKey)
        {
            if (string.IsNullOrWhiteSpace(listenKey))
            {
                throw new ArgumentException("listenKey cannot be empty. ", "listenKey");
            ...
            var result = _apiClient.CallAsync<dynamic>(ApiMethod.DELETE, EndPoints.CloseUserStream, false, $"listenKey={listenKey}");
        ...
        {
            var listenKey = StartUserStream().ListenKey;
